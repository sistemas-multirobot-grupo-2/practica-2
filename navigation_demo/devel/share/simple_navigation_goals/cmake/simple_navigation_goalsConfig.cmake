...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/jme29/Escritorio/catkin_ws_test_nav/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/jme29/Escritorio/catkin_ws_test_nav/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/jme29/Escritorio/catkin_ws_test_nav/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'paco <paco@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jme29/Escritorio/catkin_ws_test_nav/src/simple_navigation_goals/${idir}'.  Ask the maintainer 'paco <paco@todo.todo>' to fix it.")
    endif()
